...
public class KKMunnyCommand extends BaseCommand { // kk_munny <give/take/set/pay> <amount> [player]
	public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
		LiteralArgumentBuilder<CommandSourceStack> builder = Commands.literal("kk_munny").requires(source -> source.hasPermission(2));
