...
public class MagicFaith extends Magic {
	...
	public MagicFaith(ResourceLocation registryName, boolean hasToSelect, int tier, String gmAbility) {
	...
	public void magicUse(LivingEntity player, Player caster, float fullMPBlastMult, LivingEntity lockOnEntity) {
		float dmgMult = getDamageMult() + PlayerData.get(caster).getNumberOfAbilitiesEquipped(Strings.thunderBoost) * 0.25F;
