...
public class ModMagic {
	...
	public static final Supplier<Magic>
			...
			MINI = MAGIC.register(ResourceLocation.parse(Strings.Magic_Mini).getPath(), () -> new MagicStatusEffectRadius(ResourceLocation.parse(Strings.Magic_Mini), 0, null, ModMobEffects.MINI, SoundEvents.BEACON_AMBIENT, ParticleTypes.EFFECT)),
			SLOW = MAGIC.register(ResourceLocation.parse(Strings.Magic_Slow).getPath(), () -> new MagicStatusEffectRadius(ResourceLocation.parse(Strings.Magic_Slow), 0, null, MobEffects.MOVEMENT_SLOWDOWN, SoundEvents.BEACON_AMBIENT, ParticleTypes.EFFECT));
