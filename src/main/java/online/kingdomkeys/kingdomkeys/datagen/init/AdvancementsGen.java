...
import online.kingdomkeys.kingdomkeys.advancements.KKChoiceTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKCraftProfileHeadTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKDualWieldTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKKeybladeLevelTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKLevelUpTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKMunnyTrigger;
import online.kingdomkeys.kingdomkeys.advancements.KKOpenMenuTrigger;
...
public class AdvancementsGen implements AdvancementProvider.AdvancementGenerator {
	...
	public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
		AdvancementHolder root = Advancement.Builder.advancement()
				.display(
						new ItemStack(ModItems.kingdomKey.get()),
						Component.translatable("advancements.kingdomkeys.root"),
						Component.translatable("advancements.kingdomkeys.root.desc"),
						ResourceLocation.fromNamespaceAndPath(KingdomKeys.MODID, "textures/block/rod_sand.png"),
		...
		AdvancementHolder toSoa = Advancement.Builder.advancement()
				.parent(root)
				.display(
						new ItemStack(ModBlocks.pedestal.get()),
						Component.translatable("advancements.kingdomkeys.to_soa"),
						Component.translatable("advancements.kingdomkeys.to_soa.desc"),
		...
		AdvancementHolder soa = Advancement.Builder.advancement()
				.parent(toSoa)
				.display(
						new ItemStack(ModItems.dreamSword.get()),
						Component.translatable("advancements.kingdomkeys.choice"),
						Component.translatable("advancements.kingdomkeys.choice.desc"),
		...
		Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.woodenStick.get()),
						Component.translatable("advancements.kingdomkeys.get_stick"),
						Component.translatable("advancements.kingdomkeys.get_stick.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.struggleSword.get()),
						Component.translatable("advancements.kingdomkeys.get_struggle_weapon"),
						Component.translatable("advancements.kingdomkeys.get_struggle_weapon.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		AdvancementHolder firstLevelUp = Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.kingdomKey.get()),
						Component.translatable("advancements.kingdomkeys.levelup1"),
						Component.translatable("advancements.kingdomkeys.levelup1.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		AdvancementHolder fiftyLevelUp = Advancement.Builder.advancement()
				.parent(firstLevelUp)
				.display(
						new ItemStack(ModItems.incompleteKiblade.get()),
						Component.translatable("advancements.kingdomkeys.levelup50"),
						Component.translatable("advancements.kingdomkeys.levelup50.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(fiftyLevelUp)
				.display(
						new ItemStack(ModItems.kiblade.get()),
						Component.translatable("advancements.kingdomkeys.levelup100"),
						Component.translatable("advancements.kingdomkeys.levelup100.desc"),
		...
		AdvancementHolder obtainDrive = Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.valorOrb.get()),
						Component.translatable("advancements.kingdomkeys.obtain_drive"),
						Component.translatable("advancements.kingdomkeys.obtain_drive.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(obtainDrive)
				.display(
						new ItemStack(ModItems.finalOrb.get()),
						Component.translatable("advancements.kingdomkeys.obtain_all_drive_forms"),
						Component.translatable("advancements.kingdomkeys.obtain_all_drive_forms.desc"),
						null, AdvancementType.CHALLENGE, true, true, false)
		...
		AdvancementHolder obtainKeychain = Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.kingdomKeyChain.get()),
						Component.translatable("advancements.kingdomkeys.obtain_keychain"),
						Component.translatable("advancements.kingdomkeys.obtain_keychain.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.kiblade.get()),
						Component.translatable("advancements.kingdomkeys.obtain_kiblade"),
						Component.translatable("advancements.kingdomkeys.obtain_kiblade.desc"),
						null, AdvancementType.CHALLENGE, true, true, false)
		...
		AdvancementHolder summonKeyblade = Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.kingdomKey.get()),
						Component.translatable("advancements.kingdomkeys.summon_keyblade"),
						Component.translatable("advancements.kingdomkeys.summon_keyblade.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		AdvancementHolder upgradeKeyblade = Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.kingdomKeyD.get()),
						Component.translatable("advancements.kingdomkeys.upgrade_keyblade"),
						Component.translatable("advancements.kingdomkeys.upgrade_keyblade.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		AdvancementHolder maxKeybladeLevel = Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.oathkeeper.get()),
						Component.translatable("advancements.kingdomkeys.max_keyblade_level"),
						Component.translatable("advancements.kingdomkeys.max_keyblade_level.desc"),
						null, AdvancementType.CHALLENGE, true, true, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.oblivion.get()),
						Component.translatable("advancements.kingdomkeys.dual_wield_oblivion_oathkeeper"),
						Component.translatable("advancements.kingdomkeys.dual_wield_oblivion_oathkeeper.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.fireSpell.get()),
						Component.translatable("advancements.kingdomkeys.obtain_magic"),
						Component.translatable("advancements.kingdomkeys.obtain_magic.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.organizationRobe_Helmet.get()),
						Component.translatable("advancements.kingdomkeys.obtain_org"),
						Component.translatable("advancements.kingdomkeys.obtain_org.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		AdvancementHolder obtainProjector = Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModBlocks.moogleProjector.get()),
						Component.translatable("advancements.kingdomkeys.obtain_projector"),
						Component.translatable("advancements.kingdomkeys.obtain_projector.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.recipeD.get()),
						Component.translatable("advancements.kingdomkeys.obtain_recipe"),
						Component.translatable("advancements.kingdomkeys.obtain_recipe.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						...
						Component.translatable("advancements.kingdomkeys.get_pauldron"),
						Component.translatable("advancements.kingdomkeys.get_pauldron.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(soa)
				.display(
						new ItemStack(ModItems.iceCream.get()),
						Component.translatable("advancements.kingdomkeys.obtain_winner_stick"),
						Component.translatable("advancements.kingdomkeys.obtain_winner_stick.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						...
						Component.translatable("advancements.kingdomkeys.munny_millionaire"),
						Component.translatable("advancements.kingdomkeys.munny_millionaire.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						new ItemStack(ModItems.kingdomKey.get()),
						Component.translatable("advancements.kingdomkeys.open_menu"),
						Component.translatable("advancements.kingdomkeys.open_menu.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				.parent(root)
				.display(
						new ItemStack(ModBlocks.rodCrackedStone.get()),
						Component.translatable("advancements.kingdomkeys.to_rod"),
						Component.translatable("advancements.kingdomkeys.to_rod.desc"),
						null, AdvancementType.CHALLENGE, true, true, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						...
						Component.translatable("advancements.kingdomkeys.reach_castle_oblivion"),
						Component.translatable("advancements.kingdomkeys.reach_castle_oblivion.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		Advancement.Builder.advancement()
				...
				.display(
						...
						Component.translatable("advancements.kingdomkeys.play_music_disc"),
						Component.translatable("advancements.kingdomkeys.play_music_disc.desc"),
						null, AdvancementType.GOAL, true, false, false)
		...
		// Dev heads
		ItemStack whc56Head = new ItemStack(Items.PLAYER_HEAD);
		whc56Head.set(DataComponents.PROFILE, new ResolvableProfile(Optional.of("Wehavecookies56"), Optional.empty(), new PropertyMap()));

		AdvancementHolder craftCookies = Advancement.Builder.advancement()
				.parent(root)
				.display(
						whc56Head,
						Component.translatable("advancements.kingdomkeys.craft_wehavecookies56_skull"),
						Component.translatable("advancements.kingdomkeys.craft_wehavecookies56_skull.desc"),
						null, AdvancementType.GOAL, true, false, true)
				.addCriterion("crafted", ModAdvancements.CRAFT_PROFILE_HEAD.get().createCriterion(new KKCraftProfileHeadTrigger.TriggerInstance(Optional.empty(), "Wehavecookies56")))
				.rewards(AdvancementRewards.Builder.experience(50))
				.save(saver, KingdomKeys.rl("craft_wehavecookies56_skull"), existingFileHelper);

		ItemStack abelatoxHead = new ItemStack(Items.PLAYER_HEAD);
		abelatoxHead.set(DataComponents.PROFILE, new ResolvableProfile(Optional.of("Abelatox"), Optional.empty(), new PropertyMap()));

		AdvancementHolder craftAbelatox = Advancement.Builder.advancement()
				.parent(craftCookies)
				.display(
						abelatoxHead,
						Component.translatable("advancements.kingdomkeys.craft_abelatox_skull"),
						Component.translatable("advancements.kingdomkeys.craft_abelatox_skull.desc"),
						null, AdvancementType.GOAL, true, false, true)
				.addCriterion("crafted", ModAdvancements.CRAFT_PROFILE_HEAD.get().createCriterion(new KKCraftProfileHeadTrigger.TriggerInstance(Optional.empty(), "Abelatox")))
				.rewards(AdvancementRewards.Builder.experience(50))
				.save(saver, KingdomKeys.rl("craft_abelatox_skull"), existingFileHelper);

		// All of them
		Advancement.Builder.advancement()
				.parent(craftAbelatox)
				.display(
						new ItemStack(Items.PLAYER_HEAD),
						Component.translatable("advancements.kingdomkeys.both_dev_skulls"),
						Component.translatable("advancements.kingdomkeys.both_dev_skulls.desc"),
						null, AdvancementType.CHALLENGE, true, true, false)
				.addCriterion("wehavecookies56", ModAdvancements.CRAFT_PROFILE_HEAD.get().createCriterion(new KKCraftProfileHeadTrigger.TriggerInstance(Optional.empty(), "Wehavecookies56")))
				.addCriterion("abelatox", ModAdvancements.CRAFT_PROFILE_HEAD.get().createCriterion(new KKCraftProfileHeadTrigger.TriggerInstance(Optional.empty(), "Abelatox")))
				.requirements(new AdvancementRequirements(List.of(List.of("wehavecookies56"), List.of("abelatox"))))
				.rewards(AdvancementRewards.Builder.experience(200))
				.save(saver, KingdomKeys.rl("both_dev_skulls"), existingFileHelper);
	}
}
