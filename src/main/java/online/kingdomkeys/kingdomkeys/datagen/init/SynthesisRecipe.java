...
public class SynthesisRecipe extends SynthesisRecipeProvider {
	...
	protected void registerRecipe() {
		...
		getBuilder(Strings.voidGear).output(Strings.voidGearChain, 1).addMaterial(Strings.SM_WrithingShard, 1).addMaterial(Strings.SM_SinisterCrystal, 4).addMaterial(Strings.SM_SinisterShard, 5).addMaterial(Strings.SM_SinisterGem, 3).addMaterial(Strings.SM_SinisterStone, 4);
