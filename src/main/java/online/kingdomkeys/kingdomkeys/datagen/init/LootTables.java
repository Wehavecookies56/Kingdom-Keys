...
public class LootTables extends BaseLootTables {
    ...
    private void blox() {
        ...
        lootTables.put(ModBlocks.prizeBlox.get(), LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.soothing_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.blazing_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.hungry_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.twilight_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.tranquility_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.stormy_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.remembrance_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.lucid_shard.get()).weight(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.frost_shard.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.wellspring_shard.get()).weight(1))
	            
	            .addEntry(ItemLootEntry.builder(ModItems.soothing_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.blazing_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.hungry_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.twilight_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.tranquility_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.stormy_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.remembrance_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.lucid_stone.get()).weight(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.frost_stone.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.wellspring_stone.get()).weight(1))
	            
	            .addEntry(ItemLootEntry.builder(ModItems.fluorite.get()).weight(3))
	            .addEntry(ItemLootEntry.builder(ModItems.damascus.get()).weight(2))
        ...
        lootTables.put(ModBlocks.rarePrizeBlox.get(), LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.soothing_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.blazing_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.hungry_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.twilight_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.tranquility_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.stormy_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.remembrance_gem.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.lucid_gem.get()).weight(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.frost_gem.get()).weight(1))
	            
	            .addEntry(ItemLootEntry.builder(ModItems.soothing_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.blazing_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.hungry_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.twilight_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.tranquility_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.stormy_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.remembrance_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.lucid_crystal.get()).weight(1))
	            ...
	            .addEntry(ItemLootEntry.builder(ModItems.frost_crystal.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.wellspring_crystal.get()).weight(1))
	            
	            .addEntry(ItemLootEntry.builder(ModItems.orichalcum.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.orichalcumplus.get()).weight(1))
	            .addEntry(ItemLootEntry.builder(ModItems.manifest_illusion.get()).weight(1))
	...
	private void addOreLootTable(Block block, Item crystal, Item gem, Item stone, Item shard) {
		 lootTables.put(block, LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1))
	                .addEntry(ItemLootEntry.builder(crystal).weight(1)
	                		.acceptFunction(ApplyBonus.oreDrops(Enchantments.FORTUNE)))
	                .addEntry(ItemLootEntry.builder(gem).weight(2)
	                		.acceptFunction(ApplyBonus.oreDrops(Enchantments.FORTUNE)))
	                .addEntry(ItemLootEntry.builder(stone).weight(3)
	                		.acceptFunction(ApplyBonus.oreDrops(Enchantments.FORTUNE)))
	                .addEntry(ItemLootEntry.builder(shard).weight(4)
	                		.acceptFunction(ApplyBonus.oreDrops(Enchantments.FORTUNE))))
	        );
