...
public class KeybladeStats extends KeybladeProvider {
    ...
    protected void registerKeyblades() {
		...
		addStats(Strings.bondOfFlame, Strings.bondOfFlameChain, 6, 6, ModAbilities.FIRE_BOOST.toString(), 5.0F, "Enhances magic to increase damage dealt by fire-based attacks.");
		addStats(Strings.bondOfTheBlaze, Strings.bondOfTheBlazeChain, 6, 7, ModAbilities.FIRE_BOOST.toString(), 5.0F, "The Keyblade wielded by Lea.");
		addStats(Strings.braveheart, Strings.braveheartChain, 5, 4, "", 5.0F, "Riku's Keyblade after the Way to the Dawn was broken.");
		addStats(Strings.brightcrest, Strings.brightcrestChain, 5, 6, ModAbilities.FULL_MP_BLAST.toString(), 6.0F, "A Keyblade with long reach that provides an outstanding boost in Magic. It also makes it easier to land critical hits, and deals higher damage when you do.");
		...
		addStats(Strings.circleOfLife, Strings.circleOfLifeChain, 6, 2, ModAbilities.MP_HASTE.toString(), 5.0F, "Has great strength, increasing MP restoration speed after MP is consumed.");
		addStats(Strings.classicTone, Strings.classicToneChain, 6, 9, ModAbilities.MP_HASTE.toString(), 5.0F, "A Keyblade with an emphasis on Magic.");
		...
		addStats(Strings.diamondDust, Strings.diamondDustChain, 4, 9, ModAbilities.BLIZZARD_BOOST.toString(), 5.0F, "Greatly enhances magic and summon power. Raises max MP by 3.");
		...
		addStats(Strings.followTheWind, Strings.followTheWindChain, 4, 2, ModAbilities.TREASURE_MAGNET.toString(), 5.0F, "Draws in nearby orbs.");
		...
		addStats(Strings.grandChef, Strings.grandChefChain, 4, 6, ModAbilities.FIRE_BOOST.toString(), 5.0F, "A Keyblade with an emphasis on Magic.");
		...
		addStats(Strings.gullWing, Strings.gullWingChain, 4, 5, ModAbilities.EXPERIENCE_BOOST.toString(), 5.0F, "Greatly increases the amount of experience gained when defeating an enemy at a critical moment.");
		addStats(Strings.happyGear, Strings.happyGearChain, 6, 2, ModAbilities.FULL_MP_BLAST.toString(), 6.0F, "A Keyblade with an emphasis on Strength.");
		...
		addStats(Strings.hiddenDragon, Strings.hiddenDragonChain, 4, 4, ModAbilities.MP_RAGE.toString(), 5.0F, "Restores MP relative to the amount of damage taken.");
		addStats(Strings.hunnySpout, Strings.hunnySpoutChain, 4, 4, ModAbilities.MP_HASTE.toString(), 5.0F, "A well-balanced Keyblade.");
		...
		addStats(Strings.kingdomKey, Strings.kingdomKeyChain, 4, 1, ModAbilities.DAMAGE_CONTROL.toString(), 5.0F, "The key chain attached draws out the Keyblade's true form and power.");
		...
		addStats(Strings.maverickFlare, Strings.maverickFlareChain, 8, 4, ModAbilities.FIRE_BOOST.toString(), 5.0F, "A weapon that offers high Strength and ground combo speed.");
		...
		addStats(Strings.mysteriousAbyss, Strings.mysteriousAbyssChain, 5, 5, ModAbilities.BLIZZARD_BOOST.toString(), 5.0F, "Enhances magic to increase damage dealt by blizzard-based attacks.");
		...
		addStats(Strings.oathkeeper, Strings.oathkeeperChain, 7, 7, ModAbilities.FORM_BOOST.toString(), 5.0F, "Enhances magic and increases the duration of a Drive Form.");
		addStats(Strings.oblivion, Strings.oblivionChain, 8, 5, ModAbilities.DRIVE_BOOST.toString(), 5.0F, "Has great strength, and allows the Drive Gauge to restore quickly during MP Charge.");
		addStats(Strings.oceansRage, Strings.oceansRageChain, 5, 5, ModAbilities.BLIZZARD_BOOST.toString(), 5.0F, "A Keyblade that lands fewer critical hits, but compensates with a boost in Magic and more frequent Reality Shifts.");
		...
		addStats(Strings.photonDebugger, Strings.photonDebuggerChain, 5, 3, ModAbilities.THUNDER_BOOST.toString(), 5.0F, "Increases damage done by thunder-based attacks.");
		...
		addStats(Strings.pumpkinhead, Strings.pumpkinheadChain, 6, 2, ModAbilities.CRITICAL_BOOST.toString(), 6.0F, "Has a long reach and the ability to deal a string of critical blows.");
		...
		addStats(Strings.spellbinder, Strings.spellbinderChain, 4, 8, ModAbilities.FULL_MP_BLAST.toString(), 5.0F, "Raises max MP by 2, and significantly enhances magic and summon power.");
		...
		addStats(Strings.starlight, Strings.starlightChain, 5, 5, ModAbilities.MP_HASTE.toString(), 5.0F, "A basic Keyblade which is associated with the force of Light.");
		...
		addStats(Strings.sweetMemories, Strings.sweetMemoriesChain, 4, 8, ModAbilities.LUCKY_LUCKY.toString(), 5.0F, "Although it does not enhance attack strength, it increases the drop rate of items.");
		...
		addStats(Strings.twoBecomeOne, Strings.twoBecomeOneChain, 7, 6, ModAbilities.LIGHT_AND_DARKNESS.toString(), 5.0F, "A weapon of great strength and magic that has a special effect.");
		addStats(Strings.ultimaWeaponBBS, Strings.ultimaWeaponBBSChain, 9, 7, ModAbilities.MP_HASTEGA.toString(), 5.0F, "The most powerful of Keyblades.");
		addStats(Strings.ultimaWeaponDDD, Strings.ultimaWeaponDDDChain, 9, 7, ModAbilities.MP_HASTEGA.toString(), 5.0F, "An outstanding Keyblade that boosts all stats, and makes it easy to both land critical hits and trigger Reality Shifts.");
		addStats(Strings.ultimaWeaponKH1, Strings.ultimaWeaponKH1Chain, 9, 6, ModAbilities.MP_HASTEGA.toString(), 5.0F, "The ultimate Keyblade. Raises max MP by 2, and possesses maximum power and attributes.");
		addStats(Strings.ultimaWeaponKH2, Strings.ultimaWeaponKH2Chain, 9, 7, ModAbilities.MP_HASTEGA.toString(), 5.0F, "The Keyblade above all others, holding all power and will increase MP restoration rate, once all MP has been consumed.");
		addStats(Strings.ultimaWeaponKH3, Strings.ultimaWeaponKH3Chain, 9, 7, ModAbilities.MP_HASTEGA.toString(), 5.0F, "The supreme Keyblade.");
		...
		addStats(Strings.winnersProof, Strings.winnersProofChain, 8, 9, ModAbilities.ZERO_EXP.toString(), 5.0F, "Has high strength and hold's an excellent magic power. When the enemies are defeated, experience points are not gained.");
		addStats(Strings.wishingLamp, Strings.wishingLampChain, 6, 5, ModAbilities.JACKPOT.toString(), 5.0F, "Wishes come true by increasing the drop rate of munny, HP and MP orbs.");
