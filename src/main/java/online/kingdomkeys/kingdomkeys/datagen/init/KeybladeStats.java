...
public class KeybladeStats extends KeybladeProvider {
    ...
    protected void registerKeyblades() {
		...
		getBuilder(Strings.chaosRipper).keychain(Strings.chaosRipperChain).baseStats(18,-4)
            .abilities("Treasure Magnet", "Formchange Extender")
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(18,-3).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(19,-3).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 3)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(19,-2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 4)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(20,-2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Damascus, 1).addMaterial(Strings.SM_WellspringStone, 1)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(20,-1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Damascus, 1).addMaterial(Strings.SM_WellspringStone, 2)
                    .addMaterial(Strings.SM_WrithingStone, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(21,-1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Damascus, 1).addMaterial(Strings.SM_WellspringStone, 3)
                    .addMaterial(Strings.SM_WrithingStone, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(21,0).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Adamantite, 1).addMaterial(Strings.SM_WellspringGem, 1)
                    .addMaterial(Strings.SM_WrithingGem, 1)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(22,0).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Adamantite, 1).addMaterial(Strings.SM_WellspringGem, 2)
                    .addMaterial(Strings.SM_WrithingStone, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(23,0).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Adamantite, 1).addMaterial(Strings.SM_WellspringGem, 3)
                    .addMaterial(Strings.SM_WrithingStone, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(23,1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Electrum, 1).addMaterial(Strings.SM_WellspringCrystal, 1)
                    .addMaterial(Strings.SM_WrithingCrystal, 1)).build())
		...
		getBuilder(Strings.woodenKeyblade).keychain(Strings.woodenKeybladeChain).baseStats(1,0)
            .abilities("Treasure Magnet", "Formchange Extender")
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(1,1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(2,1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 3)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(2,2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 4)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(3,2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Damascus, 1).addMaterial(Strings.SM_WellspringStone, 1)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(3,3).withMaterials(new Recipe()
            ...
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(6,5).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Electrum, 1).addMaterial(Strings.SM_WellspringCrystal, 1)
                    .addMaterial(Strings.SM_WrithingCrystal, 1)).build())
            .desc("A toy Keyblade that originally belonged to Terra, which was later bestowed upon Ventus.");

		getBuilder(Strings.woodenStick).keychain(Strings.woodenStickChain).baseStats(0,0)
            .abilities("Treasure Magnet", "Formchange Extender")
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(0,1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 2)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(1,1).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 3)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(1,2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Fluorite, 1).addMaterial(Strings.SM_WellspringShard, 4)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(2,2).withMaterials(new Recipe()
                    .addMaterial(Strings.SM_Damascus, 1).addMaterial(Strings.SM_WellspringStone, 1)).build())
            .level( new KeybladeLevel.KeybladeLevelBuilder().withStats(2,3).withMaterials(new Recipe()
