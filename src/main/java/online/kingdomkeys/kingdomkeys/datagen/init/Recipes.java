...
public class Recipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.eraqus_Helmet.get())
                .pattern("LOL")
                .pattern("DAD")
                .define('L', Blocks.IRON_BLOCK)
                .define('A', ModItems.terra_Helmet.get())
                .define('D', Items.DRAGON_BREATH)
                .define('O', Items.OBSIDIAN)
                .group("kingdomkeys")
                .unlockedBy("terra_helmet", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.terra_Helmet.get()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.eraqus_Chestplate.get())
                ...
                .pattern("ODO")
                .define('L', Blocks.IRON_BLOCK)
                .define('A', ModItems.aqua_Chestplate.get())
                .define('D', Items.DRAGON_BREATH)
                .define('O', Items.OBSIDIAN)
                .group("kingdomkeys")
                .unlockedBy("aqua_chestplate", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.aqua_Chestplate.get()))
                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.vanitas_Helmet.get())
                ...
                .define('A', Items.DIAMOND_HELMET)
                .define('L', Blocks.REDSTONE_BLOCK)
                .group("kingdomkeys")
