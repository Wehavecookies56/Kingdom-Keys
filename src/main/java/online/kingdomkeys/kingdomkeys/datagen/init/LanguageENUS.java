...
public class LanguageENUS extends KKLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(Strings.abaddonPlasma + ".desc", "A weapon that lets you string together faster, incredibly long ground combos.");
        add(Strings.abyssalTide + ".desc", "A weapon that performs very well in midair. Excellent for taking on fliers.");
        add(Strings.acedsKeyblade + ".desc", "The Keyblade owned by Ursus' Foreteller.");
        add(Strings.adventRed + ".desc", "A Keyblade that courses with mystic power.");
        add(Strings.allForOne + ".desc", "A Keyblade that triggers fewer Reality Shifts, but compensates with a boost in Magic and more frequent critical hits.");
        add(Strings.astralBlast + ".desc", "A weapon that lets you string together longer ground and aerial combos.");
        add(Strings.aubade + ".desc", "A weapon that draws forth its wielder's personality.");
        add(Strings.avasKeyblade + ".desc", "The Keyblade owned by Vulpeus' Foreteller.");
        add(Strings.bondOfFlame + ".desc", "Enhances magic to increase damage dealt by fire-based attacks.");
        add(Strings.bondOfTheBlaze + ".desc", "The Keyblade wielded by Lea.");
        add(Strings.braveheart + ".desc", "Riku's Keyblade after the Way to the Dawn was broken.");
        add(Strings.brightcrest + ".desc", "A Keyblade with long reach that provides an outstanding boost in Magic. It also makes it easier to land critical hits, and deals higher damage when you do.");
        add(Strings.chaosRipper + ".desc", "A Keyblade with long reach that does little for your Magic, but provides an outstanding boost in Strength.");
        add(Strings.circleOfLife + ".desc", "Has great strength, increasing MP restoration speed after MP is consumed.");
        add(Strings.classicTone + ".desc", "A Keyblade with an emphasis on Magic.");
        add(Strings.counterpoint + ".desc", "A Keyblade with long reach that provides an extra boost in Magic and makes it easier to trigger Reality Shifts.");
        add(Strings.crabclaw + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals good physical damage.");
        add(Strings.crownOfGuilt + ".desc", "A weapon that boosts your Magic to give it incredible power.");
        add(Strings.crystalSnow + ".desc", "A Keyblade with an emphasis on Magic.");
        add(Strings.darkerThanDark + ".desc", "A weapon that offers high Magic and combo reach.");
        add(Strings.darkgnaw + ".desc", "A Keyblade that makes up for its poor reach and low critical hit ratio by providing an extra boost in Strength.");
        add(Strings.dawnTillDusk + ".desc", "A Keyblade that courses with mystic power.");
        add(Strings.decisivePumpkin + ".desc", "The greater number of combos landed, the more damage is dealt, leading to a strong finishing move!");
        add(Strings.destinysEmbrace + ".desc", "A Keyblade that makes it easier to land critical hits.");
        add(Strings.diamondDust + ".desc", "Greatly enhances magic and summon power. Raises max MP by 3.");
        add(Strings.divewing + ".desc", "A Keyblade with long reach that provides an extra boost in Magic and makes it easier to trigger Reality Shifts.");
        add(Strings.divineRose + ".desc", "A powerful weapon that is difficult to deflect. Capable of dealing a string of critical blows.");
        add(Strings.dualDisc + ".desc", "A Keyblade that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(Strings.earthshaker + ".desc", "The Keyblade Terra started out with. What it lacks in reach it makes up for with a slight boost in Strength.");
        add(Strings.elementalEncoder + ".desc", "A Keyblade that courses with mystic power.");
        add(Strings.endOfPain + ".desc", "A Keyblade with high magical power and critical hit rate, but reduces the occurrence of Reality Shift.");
        add(Strings.endsOfTheEarth, "A well-balanced Keyblade that provides an extra boost to all your stats.");
        add(Strings.everAfter + ".desc", "A Keyblade with an emphasis on Magic.");
        add(Strings.fairyHarp + ".desc", "Raises max MP by 1, and enhances magic and summon power. Sometimes deals powerful critical blows.");
        add(Strings.fairyStars + ".desc", "A Keyblade that provides a balanced boost in Strength and Magic.");
        add(Strings.fatalCrest + ".desc", "Increases strength during MP Charge and allows unlimited chaining of combos.");
        add(Strings.favoriteDeputy + ".desc", "A Keyblade with an emphasis on Strength.");
        add(Strings.fenrir + ".desc", "Has great range and strength, but maximum ground and midair combos are decreased by 1.");
        add(Strings.ferrisGear + ".desc", "A Keyblade that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(Strings.followTheWind + ".desc", "Draws in nearby orbs.");
        add(Strings.frolicFlame + ".desc", "A well-balanced Keyblade that provides an extra boost to all of your stats.");
        add(Strings.glimpseOfDarkness + ".desc", "A weapon that possesses very high Strength. Effective against tough enemies.");
        add(Strings.grandChef + ".desc", "A Keyblade with an emphasis on Magic.");
        add(Strings.guardianBell + ".desc", "A Keyblade with long reach that provides an extra boost in Magic.");
        add(Strings.guardianSoul + ".desc", "Has great strength, increasing the amount of damage dealt from Reaction Commands.");
        add(Strings.gulasKeyblade + ".desc", "The Keyblade owned by Leopardos' Foreteller.");
        add(Strings.gullWing + ".desc", "Greatly increases the amount of experience gained when defeating an enemy at a critical moment.");
        add(Strings.happyGear + ".desc", "A Keyblade with an emphasis on Strength.");
        add(Strings.herosCrest + ".desc", "Increases the damage of the finishing move in the air relative to the number of hits in the combo.");
        add(Strings.herosOrigin + ".desc", "A Keyblade with an emphasis on Strength.");
        add(Strings.hiddenDragon + ".desc", "Restores MP relative to the amount of damage taken.");
        add(Strings.hunnySpout + ".desc", "A well-balanced Keyblade.");
        add(Strings.hyperdrive + ".desc", "A Keyblade with above-average reach that provides a balanced boost in Strength and Magic.");
        add(Strings.incompleteKiblade + ".desc", "An incomplete form of the legendary Keyblade, the \u03c7-blade.");
        add(Strings.invisKeyblade + ".desc", "The Keyblade owned by Anguis' Foreteller.");
        add(Strings.irasKeyblade + ".desc", "The Keyblade owned by Unicornis' Foreteller.");
        add(Strings.jungleKing + ".desc", "Has a long reach, but seldom deals critical blows.");
        add(Strings.keybladeOfPeoplesHearts + ".desc", "A keyblade with the ability to unlock a person's heart, releasing the darkness within.");
        add(Strings.kiblade + ".desc", "A legendary weapon, the original Keyblade which all other are imperfectly modeled after.");
        add(Strings.kingdomKey + ".desc", "The key chain attached draws out the Keyblade's true form and power.");
        add(Strings.kingdomKeyD + ".desc", "A Keyblade which mirrors the Kingdom Key from the Realm of Darkness.");
        add(Strings.knockoutPunch + ".desc", "A Keyblade that lands fewer critical hits, but compensates with a Strength boost and more frequent Reality Shifts.");
        add(Strings.ladyLuck + ".desc", "Raises max MP by 2, and significantly enhances magic and summon power. Also inflicts good physical damage.");
        add(Strings.leviathan + ".desc", "A weapon that performs extremely well in midair. Outstanding for taking on fliers.");
        add(Strings.lionheart + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals great physical damage.");
        add(Strings.lostMemory + ".desc", "A Keyblade with long reach that makes it easier to land critical hits, and deals higher damage when you do.");
        add(Strings.lunarEclipse + ".desc", "A weapon that boosts versatility by greatly boosting both Strength and Magic.");
        add(Strings.markOfAHero + ".desc", "A Keyblade that provides an extra boost in Strength and deals higher damage when you land a critical hit.");
        add(Strings.mastersDefender + ".desc", "Master Eraqus's Keyblade. All of its stats are high.");
        add(Strings.maverickFlare + ".desc", "A weapon that offers high Strength and ground combo speed.");
        add(Strings.metalChocobo + ".desc", "Possesses incredible power and reach, but reduces max MP by 1. Rarely deals critical blows.");
        add(Strings.midnightBlue + ".desc", "A Keyblade imbued with wondrous power.");
        add(Strings.midnightRoar + ".desc", "A weapon that possesses high Strength. Useful against tough enemies.");
        add(Strings.mirageSplit + ".desc", "A Keyblade formed from a Reality Shift in The World That Never Was.");
        add(Strings.missingAche + ".desc", "A weapon that lets you string together faster, longer ground combos.");
        add(Strings.monochrome + ".desc", "Increases the effect of restoration items used on the field.");
        add(Strings.moogleOGlory + ".desc", "Kupo.");
        add(Strings.mysteriousAbyss + ".desc", "Enhances magic to increase damage dealt by blizzard-based attacks.");
        add(Strings.nanoGear + ".desc", "A well-balanced Keyblade.");
        add(Strings.nightmaresEnd + ".desc", "A Keyblade formed from a Reality Shift in The World That Never Was.");
        add(Strings.nightmaresEndAndMirageSplit + ".desc", "A Keyblade formed by combining both the Mirage Split and Nightmare's End.");
        add(Strings.noName + ".desc", "The Keyblade wielded by Master Xehanort.");
        add(Strings.noNameBBS + ".desc", "A Keyblade with long reach that provides an outstanding boost in Magic and makes it easier to land critical hits.");
        add(Strings.oathkeeper + ".desc", "Enhances magic and increases the duration of a Drive Form.");
        add(Strings.oblivion + ".desc", "Has great strength, and allows the Drive Gauge to restore quickly during MP Charge.");
        add(Strings.oceansRage + ".desc", "A Keyblade that lands fewer critical hits, but compensates with a boost in Magic and more frequent Reality Shifts.");
        add(Strings.olympia + ".desc", "A powerful weapon that is difficult to deflect. Capable of inflicting mighty critical blows.");
        add(Strings.omegaWeapon + ".desc", "A formidable weapon with exceptional capabilities.");
        add(Strings.ominousBlight + ".desc", "A weapon that lets you string together faster, much longer ground combos.");
        add(Strings.oneWingedAngel + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals great physical damage.");
        add(Strings.painOfSolitude + ".desc", "A weapon that boosts your Magic to give it more power.");
        add(Strings.phantomGreen + ".desc", "A Keyblade imbued with wondrous power.");
        add(Strings.photonDebugger + ".desc", "Increases damage done by thunder-based attacks.");
        add(Strings.pixiePetal + ".desc", "A Keyblade that makes up for its poor reach with an extra boost in Magic. It also makes it easier to land critical hits, and deals higher damage when you do.");
        add(Strings.pumpkinhead + ".desc", "Has a long reach and the ability to deal a string of critical blows.");
        add(Strings.rainfell + ".desc", "The Keyblade Aqua started out with. What it lacks in reach it makes up for with a balanced boost to Strength and Magic.");
        add(Strings.rejectionOfFate + ".desc", "A weapon that enables your attacks to reach a wide area and deal immense damage.");
        add(Strings.royalRadiance + ".desc", "A Keyblade with long reach that makes it easier to land critical hits, and deals higher damage when you do.");
        add(Strings.rumblingRose + ".desc", "Has great strength, allowing finishing combo moves to be unleashed successively.");
        add(Strings.shootingStar + ".desc", "A Keyblade with an emphasis on Magic.");
        add(Strings.signOfInnocence, "A weapon that boosts your Magic to give it a lot more power.");
        add(Strings.silentDirge + ".desc", "A weapon that provides versatility by boosting both Strength and Magic.");
        add(Strings.skullNoise + ".desc", "A Keyblade that provides a balanced boost in Strength and Magic.");
        add(Strings.sleepingLion + ".desc", "Well-balanced with strength and magic, increasing maximum ground-based combos by 1.");
        add(Strings.soulEater + ".desc", "A sword that swims with darkness. Possesses high Strength.");
        add(Strings.spellbinder + ".desc", "Raises max MP by 2, and significantly enhances magic and summon power.");
        add(Strings.starCluster + ".desc", "Mickey's Keyblade, also known as Kingdom Key W.");
        add(Strings.starSeeker + ".desc", "Increases maximum combo by 1 when in midair.");
        add(Strings.starlight + ".desc", "A basic Keyblade which is associated with the force of Light.");
        add(Strings.stormfall + ".desc", "A well-balanced Keyblade that provides an extra boost to all your stats.");
        add(Strings.strokeOfMidnight + ".desc", "A Keyblade that makes it easier to land critical hits.");
        add(Strings.sweetDreams + ".desc", "A Keyblade with long reach that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(Strings.sweetMemories + ".desc", "Although it does not enhance attack strength, it increases the drop rate of items.");
        add(Strings.sweetstack + ".desc", "A Keyblade that provides an extra boost in Strength and ensures every strike is a critical hit.");
        add(Strings.threeWishes + ".desc", "A powerful weapon that is difficult to deflect.");
        add(Strings.totalEclipse + ".desc", "A weapon that possesses extreme Strength. Devastates tough enemies.");
        add(Strings.treasureTrove + ".desc", "A Keyblade that makes up for its poor reach with a balanced boost in Strength and Magic.");
        add(Strings.trueLightsFlight + ".desc", "A weapon that enables your attacks to reach a wide area and deal heavy damage.");
        add(Strings.twilightBlaze + ".desc", "A weapon that boasts superior Strength and ground combo speed.");
        add(Strings.twoBecomeOne + ".desc", "A weapon of great strength and magic that has a special effect.");
        add(Strings.ultimaWeaponBBS + ".desc", "The most powerful of Keyblades.");
        add(Strings.ultimaWeaponDDD + ".desc", "An outstanding Keyblade that boosts all stats, and makes it easy to both land critical hits and trigger Reality Shifts.");
        add(Strings.ultimaWeaponKH1 + ".desc", "The ultimate Keyblade. Raises max MP by 2, and possesses maximum power and attributes.");
        add(Strings.ultimaWeaponKH2 + ".desc", "The Keyblade above all others, holding all power and will increase MP restoration rate, once all MP has been consumed.");
        add(Strings.ultimaWeaponKH3 + ".desc", "The supreme Keyblade.");
        add(Strings.umbrella + ".desc", "This looks awfully familiar...");
        add(Strings.unbound + ".desc", "Keyblade perfection. It boosts all stats, while making it easy to land critical hits and even easier to trigger Reality Shifts.");
        add(Strings.victoryLine + ".desc", "A Keyblade with above-average reach that makes it easier to land critical hits.");
        add(Strings.voidGear + ".desc", "A Keyblade with long reach that provides an outstanding boost in Strength and deals higher damage when you land a critical hit.");
        add(Strings.voidGearRemnant + ".desc", "A Keyblade with long reach that provides an outstanding boost in Strength and deals higher damage when you land a critical hit.");
        add(Strings.wayToTheDawn + ".desc", "Deals various attacks.");
        add(Strings.waywardWind + ".desc", "The Keyblade Ventus started out with. What it lacks in reach it makes up for with a slight boost in Strength.");
        add(Strings.wheelOfFate + ".desc", "A Keyblade with an emphasis on Strength.");
        add(Strings.winnersProof + ".desc", "Has high strength and hold's an excellent magic power. When the enemies are defeated, experience points are not gained.");
        add(Strings.wishingLamp + ".desc", "Wishes come true by increasing the drop rate of munny, HP and MP orbs.");
        add(Strings.wishingStar + ".desc", "Has a short reach, but always finishes up a combo attack with a powerful critical blow.");
        add(Strings.youngXehanortsKeyblade + ".desc", "The Keyblade weilded by Young Xehanort.");
        add(Strings.zeroOne + ".desc", "A Keyblade newly wrought within the datascape. Its powers render all opponents helpless.");
        add(Strings.k111 + ".desc", "A keyblade from a long forgotten age, it seems to resemble something familiar...");
