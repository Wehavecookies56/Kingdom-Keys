...
public class LanguageENUS extends KKLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModItems.abaddonPlasma + ".desc", "A weapon that lets you string together faster, incredibly long ground combos.");
        add(ModItems.abyssalTide + ".desc", "A weapon that performs very well in midair. Excellent for taking on fliers.");
        add(ModItems.acedsKeyblade + ".desc", "The Keyblade owned by Ursus' Foreteller.");
        add(ModItems.adventRed + ".desc", "A Keyblade that courses with mystic power.");
        add(ModItems.allForOne + ".desc", "A Keyblade that triggers fewer Reality Shifts, but compensates with a boost in Magic and more frequent critical hits.");
        add(ModItems.astralBlast + ".desc", "A weapon that lets you string together longer ground and aerial combos.");
        add(ModItems.aubade + ".desc", "A weapon that draws forth its wielder's personality.");
        add(ModItems.avasKeyblade + ".desc", "The Keyblade owned by Vulpeus' Foreteller.");
        add(ModItems.bondOfFlame + ".desc", "Enhances magic to increase damage dealt by fire-based attacks.");
        add(ModItems.bondOfTheBlaze + ".desc", "The Keyblade wielded by Lea.");
        add(ModItems.braveheart + ".desc", "Riku's Keyblade after the Way to the Dawn was broken.");
        add(ModItems.brightcrest + ".desc", "A Keyblade with long reach that provides an outstanding boost in Magic. It also makes it easier to land critical hits, and deals higher damage when you do.");
        add(ModItems.chaosRipper + ".desc", "A Keyblade with long reach that does little for your Magic, but provides an outstanding boost in Strength.");
        add(ModItems.circleOfLife + ".desc", "Has great strength, increasing MP restoration speed after MP is consumed.");
        add(ModItems.classicTone + ".desc", "A Keyblade with an emphasis on Magic.");
        add(ModItems.counterpoint + ".desc", "A Keyblade with long reach that provides an extra boost in Magic and makes it easier to trigger Reality Shifts.");
        add(ModItems.crabclaw + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals good physical damage.");
        add(ModItems.crownOfGuilt + ".desc", "A weapon that boosts your Magic to give it incredible power.");
        add(ModItems.crystalSnow + ".desc", "A Keyblade with an emphasis on Magic.");
        add(ModItems.darkerThanDark + ".desc", "A weapon that offers high Magic and combo reach.");
        add(ModItems.darkgnaw + ".desc", "A Keyblade that makes up for its poor reach and low critical hit ratio by providing an extra boost in Strength.");
        add(ModItems.dawnTillDusk + ".desc", "A Keyblade that courses with mystic power.");
        add(ModItems.decisivePumpkin + ".desc", "The greater number of combos landed, the more damage is dealt, leading to a strong finishing move!");
        add(ModItems.destinysEmbrace + ".desc", "A Keyblade that makes it easier to land critical hits.");
        add(ModItems.diamondDust + ".desc", "Greatly enhances magic and summon power. Raises max MP by 3.");
        add(ModItems.divewing + ".desc", "A Keyblade with long reach that provides an extra boost in Magic and makes it easier to trigger Reality Shifts.");
        add(ModItems.divineRose + ".desc", "A powerful weapon that is difficult to deflect. Capable of dealing a string of critical blows.");
        add(ModItems.dualDisc + ".desc", "A Keyblade that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(ModItems.earthshaker + ".desc", "The Keyblade Terra started out with. What it lacks in reach it makes up for with a slight boost in Strength.");
        add(ModItems.elementalEncoder + ".desc", "A Keyblade that courses with mystic power.");
        add(ModItems.endOfPain + ".desc", "A Keyblade with high magical power and critical hit rate, but reduces the occurrence of Reality Shift.");
        add(ModItems.endsOfTheEarth + ".desc", "A well-balanced Keyblade that provides an extra boost to all your stats.");
        add(ModItems.everAfter + ".desc", "A Keyblade with an emphasis on Magic.");
        add(ModItems.fairyHarp + ".desc", "Raises max MP by 1, and enhances magic and summon power. Sometimes deals powerful critical blows.");
        add(ModItems.fairyStars + ".desc", "A Keyblade that provides a balanced boost in Strength and Magic.");
        add(ModItems.fatalCrest + ".desc", "Increases strength during MP Charge and allows unlimited chaining of combos.");
        add(ModItems.favoriteDeputy + ".desc", "A Keyblade with an emphasis on Strength.");
        add(ModItems.fenrir + ".desc", "Has great range and strength, but maximum ground and midair combos are decreased by 1.");
        add(ModItems.ferrisGear + ".desc", "A Keyblade that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(ModItems.followTheWind + ".desc", "Draws in nearby orbs.");
        add(ModItems.frolicFlame + ".desc", "A well-balanced Keyblade that provides an extra boost to all of your stats.");
        add(ModItems.glimpseOfDarkness + ".desc", "A weapon that possesses very high Strength. Effective against tough enemies.");
        add(ModItems.grandChef + ".desc", "A Keyblade with an emphasis on Magic.");
        add(ModItems.guardianBell + ".desc", "A Keyblade with long reach that provides an extra boost in Magic.");
        add(ModItems.guardianSoul + ".desc", "Has great strength, increasing the amount of damage dealt from Reaction Commands.");
        add(ModItems.gulasKeyblade + ".desc", "The Keyblade owned by Leopardos' Foreteller.");
        add(ModItems.gullWing + ".desc", "Greatly increases the amount of experience gained when defeating an enemy at a critical moment.");
        add(ModItems.happyGear + ".desc", "A Keyblade with an emphasis on Strength.");
        add(ModItems.herosCrest + ".desc", "Increases the damage of the finishing move in the air relative to the number of hits in the combo.");
        add(ModItems.herosOrigin + ".desc", "A Keyblade with an emphasis on Strength.");
        add(ModItems.hiddenDragon + ".desc", "Restores MP relative to the amount of damage taken.");
        add(ModItems.hunnySpout + ".desc", "A well-balanced Keyblade.");
        add(ModItems.hyperdrive + ".desc", "A Keyblade with above-average reach that provides a balanced boost in Strength and Magic.");
        add(ModItems.incompleteKiblade + ".desc", "An incomplete form of the legendary Keyblade, the \u03c7-blade.");
        add(ModItems.invisKeyblade + ".desc", "The Keyblade owned by Anguis' Foreteller.");
        add(ModItems.irasKeyblade + ".desc", "The Keyblade owned by Unicornis' Foreteller.");
        add(ModItems.jungleKing + ".desc", "Has a long reach, but seldom deals critical blows.");
        add(ModItems.keybladeOfPeoplesHearts + ".desc", "A keyblade with the ability to unlock a person's heart, releasing the darkness within.");
        add(ModItems.kiblade + ".desc", "A legendary weapon, the original Keyblade which all other are imperfectly modeled after.");
        add(ModItems.kingdomKey + ".desc", "The key chain attached draws out the Keyblade's true form and power.");
        add(ModItems.kingdomKeyD + ".desc", "A Keyblade which mirrors the Kingdom Key from the Realm of Darkness.");
        add(ModItems.knockoutPunch + ".desc", "A Keyblade that lands fewer critical hits, but compensates with a Strength boost and more frequent Reality Shifts.");
        add(ModItems.ladyLuck + ".desc", "Raises max MP by 2, and significantly enhances magic and summon power. Also inflicts good physical damage.");
        add(ModItems.leviathan + ".desc", "A weapon that performs extremely well in midair. Outstanding for taking on fliers.");
        add(ModItems.lionheart + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals great physical damage.");
        add(ModItems.lostMemory + ".desc", "A Keyblade with long reach that makes it easier to land critical hits, and deals higher damage when you do.");
        add(ModItems.lunarEclipse + ".desc", "A weapon that boosts versatility by greatly boosting both Strength and Magic.");
        add(ModItems.markOfAHero + ".desc", "A Keyblade that provides an extra boost in Strength and deals higher damage when you land a critical hit.");
        add(ModItems.mastersDefender + ".desc", "Master Eraqus's Keyblade. All of its stats are high.");
        add(ModItems.maverickFlare + ".desc", "A weapon that offers high Strength and ground combo speed.");
        add(ModItems.metalChocobo + ".desc", "Possesses incredible power and reach, but reduces max MP by 1. Rarely deals critical blows.");
        add(ModItems.midnightBlue + ".desc", "A Keyblade imbued with wondrous power.");
        add(ModItems.midnightRoar + ".desc", "A weapon that possesses high Strength. Useful against tough enemies.");
        add(ModItems.mirageSplit + ".desc", "A Keyblade formed from a Reality Shift in The World That Never Was.");
        add(ModItems.missingAche + ".desc", "A weapon that lets you string together faster, longer ground combos.");
        add(ModItems.monochrome + ".desc", "Increases the effect of restoration items used on the field.");
        add(ModItems.moogleOGlory + ".desc", "Kupo.");
        add(ModItems.mysteriousAbyss + ".desc", "Enhances magic to increase damage dealt by blizzard-based attacks.");
        add(ModItems.nanoGear + ".desc", "A well-balanced Keyblade.");
        add(ModItems.nightmaresEnd + ".desc", "A Keyblade formed from a Reality Shift in The World That Never Was.");
        add(ModItems.nightmaresEndAndMirageSplit + ".desc", "A Keyblade formed by combining both the Mirage Split and Nightmare's End.");
        add(ModItems.noName + ".desc", "The Keyblade wielded by Master Xehanort.");
        add(ModItems.noNameBBS + ".desc", "A Keyblade with long reach that provides an outstanding boost in Magic and makes it easier to land critical hits.");
        add(ModItems.oathkeeper + ".desc", "Enhances magic and increases the duration of a Drive Form.");
        add(ModItems.oblivion + ".desc", "Has great strength, and allows the Drive Gauge to restore quickly during MP Charge.");
        add(ModItems.oceansRage + ".desc", "A Keyblade that lands fewer critical hits, but compensates with a boost in Magic and more frequent Reality Shifts.");
        add(ModItems.olympia + ".desc", "A powerful weapon that is difficult to deflect. Capable of inflicting mighty critical blows.");
        add(ModItems.omegaWeapon + ".desc", "A formidable weapon with exceptional capabilities.");
        add(ModItems.ominousBlight + ".desc", "A weapon that lets you string together faster, much longer ground combos.");
        add(ModItems.oneWingedAngel + ".desc", "Raises max MP by 1, and enhances magic and summon power. Also deals great physical damage.");
        add(ModItems.painOfSolitude + ".desc", "A weapon that boosts your Magic to give it more power.");
        add(ModItems.phantomGreen + ".desc", "A Keyblade imbued with wondrous power.");
        add(ModItems.photonDebugger + ".desc", "Increases damage done by thunder-based attacks.");
        add(ModItems.pixiePetal + ".desc", "A Keyblade that makes up for its poor reach with an extra boost in Magic. It also makes it easier to land critical hits, and deals higher damage when you do.");
        add(ModItems.pumpkinhead + ".desc", "Has a long reach and the ability to deal a string of critical blows.");
        add(ModItems.rainfell + ".desc", "The Keyblade Aqua started out with. What it lacks in reach it makes up for with a balanced boost to Strength and Magic.");
        add(ModItems.rejectionOfFate + ".desc", "A weapon that enables your attacks to reach a wide area and deal immense damage.");
        add(ModItems.royalRadiance + ".desc", "A Keyblade with long reach that makes it easier to land critical hits, and deals higher damage when you do.");
        add(ModItems.rumblingRose + ".desc", "Has great strength, allowing finishing combo moves to be unleashed successively.");
        add(ModItems.shootingStar + ".desc", "A Keyblade with an emphasis on Magic.");
        add(ModItems.signOfInnocence + ".desc", "A weapon that boosts your Magic to give it a lot more power.");
        add(ModItems.silentDirge + ".desc", "A weapon that provides versatility by boosting both Strength and Magic.");
        add(ModItems.skullNoise + ".desc", "A Keyblade that provides a balanced boost in Strength and Magic.");
        add(ModItems.sleepingLion + ".desc", "Well-balanced with strength and magic, increasing maximum ground-based combos by 1.");
        add(ModItems.soulEater + ".desc", "A sword that swims with darkness. Possesses high Strength.");
        add(ModItems.spellbinder + ".desc", "Raises max MP by 2, and significantly enhances magic and summon power.");
        add(ModItems.starCluster + ".desc", "Mickey's Keyblade, also known as Kingdom Key W.");
        add(ModItems.starSeeker + ".desc", "Increases maximum combo by 1 when in midair.");
        add(ModItems.starlight + ".desc", "A basic Keyblade which is associated with the force of Light.");
        add(ModItems.stormfall + ".desc", "A well-balanced Keyblade that provides an extra boost to all your stats.");
        add(ModItems.strokeOfMidnight + ".desc", "A Keyblade that makes it easier to land critical hits.");
        add(ModItems.sweetDreams + ".desc", "A Keyblade with long reach that provides an extra boost in Strength and makes it easier to land critical hits.");
        add(ModItems.sweetMemories + ".desc", "Although it does not enhance attack strength, it increases the drop rate of items.");
        add(ModItems.sweetstack + ".desc", "A Keyblade that provides an extra boost in Strength and ensures every strike is a critical hit.");
        add(ModItems.threeWishes + ".desc", "A powerful weapon that is difficult to deflect.");
        add(ModItems.totalEclipse + ".desc", "A weapon that possesses extreme Strength. Devastates tough enemies.");
        add(ModItems.treasureTrove + ".desc", "A Keyblade that makes up for its poor reach with a balanced boost in Strength and Magic.");
        add(ModItems.trueLightsFlight + ".desc", "A weapon that enables your attacks to reach a wide area and deal heavy damage.");
        add(ModItems.twilightBlaze + ".desc", "A weapon that boasts superior Strength and ground combo speed.");
        add(ModItems.twoBecomeOne + ".desc", "A weapon of great strength and magic that has a special effect.");
        add(ModItems.ultimaWeaponBBS + ".desc", "The most powerful of Keyblades.");
        add(ModItems.ultimaWeaponDDD + ".desc", "An outstanding Keyblade that boosts all stats, and makes it easy to both land critical hits and trigger Reality Shifts.");
        add(ModItems.ultimaWeaponKH1 + ".desc", "The ultimate Keyblade. Raises max MP by 2, and possesses maximum power and attributes.");
        add(ModItems.ultimaWeaponKH2 + ".desc", "The Keyblade above all others, holding all power and will increase MP restoration rate, once all MP has been consumed.");
        add(ModItems.ultimaWeaponKH3 + ".desc", "The supreme Keyblade.");
        add(ModItems.umbrella + ".desc", "This looks awfully familiar...");
        add(ModItems.unbound + ".desc", "Keyblade perfection. It boosts all stats, while making it easy to land critical hits and even easier to trigger Reality Shifts.");
        add(ModItems.victoryLine + ".desc", "A Keyblade with above-average reach that makes it easier to land critical hits.");
        add(ModItems.voidGear + ".desc", "A Keyblade with long reach that provides an outstanding boost in Strength and deals higher damage when you land a critical hit.");
        add(ModItems.voidGearRemnant + ".desc", "A Keyblade with long reach that provides an outstanding boost in Strength and deals higher damage when you land a critical hit.");
        add(ModItems.waytotheDawn + ".desc", "Deals various attacks.");
        add(ModItems.waywardWind + ".desc", "The Keyblade Ventus started out with. What it lacks in reach it makes up for with a slight boost in Strength.");
        add(ModItems.wheelOfFate + ".desc", "A Keyblade with an emphasis on Strength.");
        add(ModItems.winnersProof + ".desc", "Has high strength and hold's an excellent magic power. When the enemies are defeated, experience points are not gained.");
        add(ModItems.wishingLamp + ".desc", "Wishes come true by increasing the drop rate of munny, HP and MP orbs.");
        add(ModItems.wishingStar + ".desc", "Has a short reach, but always finishes up a combo attack with a powerful critical blow.");
        add(ModItems.youngXehanortsKeyblade + ".desc", "The Keyblade weilded by Young Xehanort.");
        add(ModItems.zeroOne + ".desc", "A Keyblade newly wrought within the datascape. Its powers render all opponents helpless.");
        add(ModItems.k111 + ".desc", "A keyblade from a long forgotten age, it seems to resemble something familiar...");
