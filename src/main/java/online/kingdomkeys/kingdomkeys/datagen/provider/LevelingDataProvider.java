...
public class LevelingDataProvider implements DataProvider {
	...
	private static JsonObject buildWarrior(int version) {
		return new LevelingBuilder(version)
			...
			.level(5).str(1).maxHp(5).maxArmors(1).maxMagics(1).maxItems(1)
			.level(6).def(1).mag(1).ap(1)
			.level(7).str(1).abilities(ModAbilities.WALL_KICK)
			.level(8).mag(1).maxMp(8).abilities(ModAbilities.GUARD)
			.level(9).str(1).ap(1).abilities(ModAbilities.COMBO_PLUS)
			.level(10).def(1).mag(1).maxHp(5).maxMagics(1).maxAccessories(1).maxItems(1).abilities(ModAbilities.AERIAL_RECOVERY)
			...
			.level(15).str(1).maxHp(5).ap(1).maxArmors(1).maxMagics(1).maxItems(1).abilities(ModAbilities.DAMAGE_DRIVE).item(ModItems.meteorShowerShotlock, 1)
			...
			.level(20).mag(1).maxHp(5).maxMp(8).maxMagics(1).maxAccessories(1).maxItems(1).abilities(ModAbilities.JACKPOT).item(ModItems.chaosSnakeShotlock, 1)
			.level(21).str(1).ap(1).abilities(ModAbilities.ENCOUNTER_PLUS)
			.level(22).def(1).mag(1).abilities(ModAbilities.FORM_BOOST)
			.level(23).str(1).abilities(ModAbilities.COUNTERGUARD)
			.level(24).mag(1).maxMp(4).ap(1).abilities(ModAbilities.DRIVE_CONVERTER)
			.level(25).str(1).maxHp(5).maxArmors(1).maxMagics(1).maxItems(1).abilities(ModAbilities.DRIVE_BOOST).item(ModItems.pulseBombShotlock, 1)
			...
			.level(30).def(1).mag(1).maxHp(5).ap(1).maxMagics(1).maxAccessories(1).maxItems(1).abilities(ModAbilities.CURAZA)
			...
			.level(61).str(1).abilities(ModAbilities.ONCE_MORE)
	...
	private static JsonObject buildMystic(int version) {
		return new LevelingBuilder(version)
			...
			.level(6).def(1).mag(1).ap(1).maxItems(1)
			.level(7).str(1).abilities(ModAbilities.GUARD)
			...
			.level(11).str(1).item(ModItems.ragnarokShotlock, 1).abilities(ModAbilities.AERIAL_RECOVERY)
			.level(12).mag(1).maxMp(8).ap(1).maxMagics(1).maxItems(1).abilities(ModAbilities.MP_HASTE)
			...
			.level(18).def(1).mag(1).ap(1).maxItems(1).abilities(ModAbilities.FOCUS_CONVERTER)
			...
			.level(22).def(1).mag(1).abilities(ModAbilities.FORM_BOOST)
			.level(23).str(1).abilities(ModAbilities.THUNDAZA, ModAbilities.COUNTERGUARD)
			.level(24).mag(1).maxMp(4).ap(1).maxMagics(1).maxItems(1).abilities(ModAbilities.DRIVE_CONVERTER, ModAbilities.ENDLESS_MAGIC)
			...
			.level(30).def(1).mag(1).maxHp(5).ap(1).maxAccessories(1).maxItems(1).abilities(ModAbilities.WATERZA)
			.level(31).str(1).abilities(ModAbilities.TREASURE_MAGNET)
			...
			.level(36).mag(1).maxMp(4).ap(1).maxMagics(1).maxItems(1).abilities(ModAbilities.NEGATIVE_COMBO)
			.level(37).str(1).abilities(ModAbilities.FLOWSTEP)
			.level(38).def(1).mag(1).abilities(ModAbilities.EXTRA_CAST)
			.level(39).str(1).ap(1).abilities(ModAbilities.ONCE_MORE)
	...
	private static JsonObject buildGuardian(int version) {
		return new LevelingBuilder(version)
			...
			.level(3).str(1).ap(1)
			.level(4).def(1).maxMp(8).maxItems(1)
			.level(5).str(1).maxHp(5).maxArmors(1)
			.level(6).def(1).mag(1).ap(1).maxMagics(1)
			.level(7).str(1).abilities(ModAbilities.AERIAL_RECOVERY)
			.level(8).mag(1).maxMp(8).maxItems(1)
			.level(9).str(1).ap(1)
			...
			.level(15).str(1).maxHp(5).ap(1).maxArmors(1).abilities(ModAbilities.DAMAGE_DRIVE).item(ModItems.meteorShowerShotlock, 1)
			.level(16).mag(1).maxMp(8).maxItems(1).abilities(ModAbilities.MP_RAGE)
			...
			.level(20).mag(1).maxHp(5).maxMp(8).maxAccessories(1).maxItems(1).abilities(ModAbilities.JACKPOT).item(ModItems.chaosSnakeShotlock, 1)
			.level(21).str(1).ap(1).abilities(ModAbilities.CURAZA,ModAbilities.COUNTERGUARD)
			.level(22).def(1).mag(1).abilities(ModAbilities.FORM_BOOST)
			.level(23).str(1).abilities(ModAbilities.STRIKE_RAID, ModAbilities.ONCE_MORE)
			.level(24).mag(1).maxMp(4).ap(1).maxMagics(1).maxItems(1).abilities(ModAbilities.DRIVE_CONVERTER, ModAbilities.AIR_SLIDE)
			.level(25).str(1).maxHp(5).maxArmors(1).abilities(ModAbilities.DRIVE_BOOST).item(ModItems.pulseBombShotlock, 1)
