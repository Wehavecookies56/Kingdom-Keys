...
public class BlizzardEntityRenderer extends EntityRenderer<BlizzardEntity> {
	...
	public BlizzardEntityRenderer(EntityRenderDispatcher renderManager, BlizzardModel fist) {
		super(renderManager);
		this.shot = fist;
	...
	public static class Factory implements IRenderFactory<BlizzardEntity> {
		@Override
		public EntityRenderer<? super BlizzardEntity> createRenderFor(EntityRenderDispatcher manager) {
