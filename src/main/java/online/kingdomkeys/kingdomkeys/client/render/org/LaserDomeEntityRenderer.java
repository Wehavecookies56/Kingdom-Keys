...
public class LaserDomeEntityRenderer extends EntityRenderer<LaserDomeCoreEntity> {
	...
	public LaserDomeEntityRenderer(EntityRendererManager renderManager, BlizzardModel fist) {
		super(renderManager);
		this.shot = fist;
	...
	@Override
	public void render(LaserDomeCoreEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		/*matrixStackIn.push();
		{
			float r = 1, g = 0, b = 0;
	...
	@Nullable
	@Override
	public ResourceLocation getEntityTexture(LaserDomeCoreEntity entity) {
		return new ResourceLocation(KingdomKeys.MODID, "textures/entity/models/fire.png");
	}

	public static class Factory implements IRenderFactory<LaserDomeCoreEntity> {
		@Override
		public EntityRenderer<? super LaserDomeCoreEntity> createRenderFor(EntityRendererManager manager) {
