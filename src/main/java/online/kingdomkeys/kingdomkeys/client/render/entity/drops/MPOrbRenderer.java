...
public class MPOrbRenderer extends EntityItemDropRenderer {
	...
	public static class Factory implements IRenderFactory<EntityMPOrb> {
		@Override
		public EntityRenderer<? super EntityMPOrb> createRenderFor(EntityRendererManager entityRendererManager) {
