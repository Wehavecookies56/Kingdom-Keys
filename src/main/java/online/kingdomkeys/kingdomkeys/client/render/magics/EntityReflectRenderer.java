...
@OnlyIn(Dist.CLIENT)
public class EntityReflectRenderer extends EntityRenderer<EntityReflect> {

	public static final Factory FACTORY = new EntityReflectRenderer.Factory();
	ModelBlizzard shot;

	public EntityReflectRenderer(EntityRendererManager renderManager, ModelBlizzard fist) {
		super(renderManager);
		this.shot = fist;
	...
	@Override
	public void render(EntityReflect entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		/*matrixStackIn.push();
		{
			float r = 1, g = 0, b = 0;
	...
	@Nullable
	@Override
	public ResourceLocation getEntityTexture(EntityReflect entity) {
		return new ResourceLocation(KingdomKeys.MODID, "textures/entity/models/fire.png");
	}

	public static class Factory implements IRenderFactory<EntityReflect> {
		@Override
		public EntityRenderer<? super EntityReflect> createRenderFor(EntityRendererManager manager) {
			return new EntityReflectRenderer(manager, new ModelBlizzard());
		}
	}
}
