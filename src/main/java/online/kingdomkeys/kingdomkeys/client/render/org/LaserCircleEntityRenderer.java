...
public class LaserCircleEntityRenderer extends EntityRenderer<LaserCircleCoreEntity> {
	...
	@Override
	public void render(LaserCircleCoreEntity entity, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
		/*matrixStackIn.push();
		{
			float r = 1, g = 0, b = 0;
