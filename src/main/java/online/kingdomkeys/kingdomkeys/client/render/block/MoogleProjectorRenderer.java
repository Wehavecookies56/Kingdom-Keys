...
public class MoogleProjectorRenderer extends BlockEntityRenderer<MoogleProjectorTileEntity> {
    public MoogleProjectorRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {
