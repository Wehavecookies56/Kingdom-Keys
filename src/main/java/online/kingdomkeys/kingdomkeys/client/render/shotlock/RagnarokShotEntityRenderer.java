...
public class RagnarokShotEntityRenderer extends EntityRenderer<RagnarokShotEntity> {
	...
	@Override
	public void render(RagnarokShotEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		matrixStackIn.push();
    	{	
	...
	@Nullable
	@Override
	public ResourceLocation getEntityTexture(RagnarokShotEntity entity) {
