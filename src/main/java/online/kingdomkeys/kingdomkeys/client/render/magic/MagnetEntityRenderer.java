...
public class MagnetEntityRenderer extends EntityRenderer<MagnetEntity> {
	...
	public MagnetEntityRenderer(EntityRenderDispatcher renderManager, BlizzardModel fist) {
		super(renderManager);
		this.shot = fist;
	...
	public static class Factory implements IRenderFactory<MagnetEntity> {
		@Override
		public EntityRenderer<? super MagnetEntity> createRenderFor(EntityRenderDispatcher manager) {
