...
public class AquaModel<T extends LivingEntity> extends ArmorBaseModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION_TOP = new ModelLayerLocation(KingdomKeys.rl("aqua_top"), "main");
    public static final ModelLayerLocation LAYER_LOCATION_BOTTOM = new ModelLayerLocation(KingdomKeys.rl("aqua_bottom"), "main");
