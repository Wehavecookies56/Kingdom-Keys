...
public class ModelStop extends EntityModel<EntityStop> {
	...
	@Override
	public void setRotationAngles(EntityStop entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
