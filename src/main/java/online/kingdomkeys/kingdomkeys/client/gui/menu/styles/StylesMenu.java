...
public class StylesMenu extends MenuBackground {
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTicks) {
        ...
        gui.drawString(minecraft.font, playerData.getSingleStyle().toString(), 300, 50, 0xFF9900);
        gui.drawString(minecraft.font, playerData.getDualStyle().toString(), 300, 70, 0xFF9900);
        switch (window) {
            case SINGLE -> {
                for (MenuButton b : singleStyleList) {
                    b.active = true;
