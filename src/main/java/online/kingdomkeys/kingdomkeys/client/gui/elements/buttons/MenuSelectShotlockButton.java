	...
	public void renderWidget(GuiGraphics gui, int mouseX, int mouseY, float partialTicks) {
		...
		if (visible) {
			...
			if (shotlock != null && shotlock.getMaxLevel() > 1) {
				...
				gui.blit(texture, getX() + getWidth() - barWidth - 5, getY() + getHeight() - 4, barWidth, 2, 161, 67, 1, 5, 256, 256);
				gui.blit(texture, getX() + getWidth() - barWidth - 5, getY() + getHeight() - 4, percentWidth, 2, 163, 67, 1, 5, 256, 256);
			}
