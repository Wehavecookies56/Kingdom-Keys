...
public class MenuSelectArmorButton extends MenuButtonBase {
	...
	public MenuSelectArmorButton(ItemStack stack, int slot, int x, int y, int widthIn, MenuArmorSelectorScreen parent, int colour, CreateNarration nar) {
                    ...
                    if(showData) {
	                    ...
	                    if(showResistances && resistances != null) {
	                    	int pos = 0;
	                    	{
								...
								drawString(matrixStack, fr, "]", (int) strNumPosX + fr.width(resVal) + fr.width(openBracket) + fr.width(totalDefResStr), (int) posY + 10 * pos++, 0xBF6004);
	                    	}
