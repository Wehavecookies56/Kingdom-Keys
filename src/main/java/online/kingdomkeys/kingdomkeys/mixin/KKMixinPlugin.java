...
public class KKMixinPlugin implements IMixinConfigPlugin {
    ...
    private static final Supplier<Boolean> WILDFIREGENDERLOADED = () -> LoadingModList.get().getModFileById("wildfire_gender") != null;

    private static final Map<String, Supplier<Boolean>> CONDITIONS = ImmutableMap.of(
            "online.kingdomkeys.kingdomkeys.mixin.epicfight.PHumanoidRendererMixin", EFMLOADED,
            "online.kingdomkeys.kingdomkeys.mixin.epicfight.FirstPersonRendererMixin", EFMLOADED,
