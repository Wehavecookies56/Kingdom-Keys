...
public class CastleOblivionStructure extends Structure {
    ...
    public static final MapCodec<CastleOblivionStructure> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
            CastleOblivionStructure.settingsCodec(instance),
    ...
    public CastleOblivionStructure(StructureSettings config, Holder<StructureTemplatePool> startPool, int size, int pieceIndex) {
        super(config);
