...
public class ModRoomStructures {
    ...
    public static final RegistryObject<RoomStructure>
        LOBBY = ROOM_STRUCTURES.register("lobby", () -> new RoomStructure("lobby", "all", RoomProperties.RoomSize.SPECIAL, List.of(RoomProperties.RoomCategory.SPECIAL), new Size2i(33, 69))),
        TEST_ROOM = ROOM_STRUCTURES.register("test_room", () -> new RoomStructure("test_room", "all", RoomProperties.RoomSize.M, List.of(RoomProperties.RoomCategory.ENEMY, RoomProperties.RoomCategory.STATUS, RoomProperties.RoomCategory.BOUNTY), new Size2i(32, 32)));
    ...
    public static boolean isStructureCompatible(RoomStructure structure, RoomType type) {
        return type.getProperties().getSize() == structure.size && structure.categories.contains(type.getProperties().getCategory()) && type.getProperties().isFloorCompatible(structure.floor);
    }
}
