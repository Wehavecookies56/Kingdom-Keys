...
public class ShotlockChaosSnake extends Shotlock {
	private static final int SHOT_COLOR = 0xccc2ff;

	public ShotlockChaosSnake(ResourceLocation registryName, int order) {
