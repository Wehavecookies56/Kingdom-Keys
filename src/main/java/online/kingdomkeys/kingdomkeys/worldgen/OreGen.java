	...
	public static void generateOre() {
		...
		for (Biome biome : ForgeRegistries.BIOMES) {
			if(netherBiomes.contains(biome)) {
				...
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ModBlocks.sinisterOre.get().getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 0, 1, 20))));
