...
public class ModAdvancements
    {
        ...
        public static final DeferredHolder<CriterionTrigger<?>, KKOpenMenuTrigger> OPEN_MENU = TRIGGERS.register("open_menu", KKOpenMenuTrigger::new);
        ...
        public static void triggerOpenMenu(ServerPlayer player) {
            OPEN_MENU.get().trigger(player);
        }

        public static void triggerChoiceMade(ServerPlayer player) {
            CHOICE_MADE.get().trigger(player);
        }

        public static void triggerKeybladeLevel(ServerPlayer player, int currentLevel) {
            KEYBLADE_LEVEL.get().trigger(player, currentLevel);
        }
