...
public class ModBlocks {
    ...
    public static final RegistryObject<Block>
            ...
            prizeBlox = createNewBlock("prize_blox", () -> new KKOreBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(1.0F, 10.0F))),
            rarePrizeBlox = createNewBlock("rare_prize_blox", () -> new KKOreBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(1.0F, 10.0F))),
            ...
            blazingOre = createNewBlock("blazing_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F).setLightLevel((state) -> 4))),
            blazingOreN = createNewBlock("blazing_ore_n", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F).setLightLevel((state) -> 4))),
            soothingOre = createNewBlock("soothing_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            writhingOre = createNewBlock("writhing_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            writhingOreN = createNewBlock("writhing_ore_n", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            writhingOreE = createNewBlock("writhing_ore_e", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            betwixtOre = createNewBlock("betwixt_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            wellspringOre = createNewBlock("wellspring_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            wellspringOreN = createNewBlock("wellspring_ore_n", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            frostOre = createNewBlock("frost_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            lucidOre = createNewBlock("lucid_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            lightningOre = createNewBlock("lightning_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F).setLightLevel((state) -> 4))),
            pulsingOre = createNewBlock("pulsing_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            pulsingOreE = createNewBlock("pulsing_ore_e", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            remembranceOre = createNewBlock("remembrance_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            hungryOre = createNewBlock("hungry_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            sinisterOre = createNewBlock("sinister_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            stormyOre = createNewBlock("stormy_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            tranquilityOre = createNewBlock("tranquility_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F))),
            twilightOre = createNewBlock("twilight_ore", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
            twilightOreN = createNewBlock("twilight_ore_n", () -> new KKOreBlock(Block.Properties.create(Material.ROCK).harvestLevel(2).hardnessAndResistance(2.0F, 1.0F))),
