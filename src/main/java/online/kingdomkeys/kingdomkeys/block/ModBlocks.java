...
public class ModBlocks {
    ...
    public static final RegistryObject<Block>
            ...
            blazingOre = createNewBlock("blazing_ore", Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F)),
            blazingOreN = createNewBlock("blazing_ore_n", Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F)),
            ...
            lightningOre = createNewBlock("lightning_ore", Block.Properties.create(Material.ROCK).harvestLevel(1).hardnessAndResistance(2.0F, 1.0F)),
            ...
            synthesisTable = createNewBlock("synthesis_table", () -> new SynthesisTableBlock(Block.Properties.create(Material.IRON).harvestLevel(0).hardnessAndResistance(2F,1F)))
            ;
