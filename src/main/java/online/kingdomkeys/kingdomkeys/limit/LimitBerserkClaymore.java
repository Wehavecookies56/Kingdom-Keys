...
public class LimitBerserkClaymore extends Limit {

	public LimitBerserkClaymore(ResourceLocation registryName, int order, OrgMember owner) {
	...
	public void onUse(Player player, LivingEntity target) {
		...
		ClaymoreDropCoreEntity claymore = new ClaymoreDropCoreEntity(player.level(), player, damage);
		player.level().addFreshEntity(claymore);
	}
}
