        ...
        if(ModConfigs.showDriveForms && e != null && ModCapabilities.getPlayer((Player) e) != null) {
            if(!ModCapabilities.getPlayer((Player) e).getActiveDriveForm().equals(DriveForm.NONE.toString())) {
                ...
                if (form.getTextureLocation() != null) {
                    ...
                    if (DefaultPlayerSkin.getSkinModelName(e.getUUID()).equals("default")) {
                        ClientModels.LOGICAL_CLIENT.biped.drawAnimatedModel(poseStack, vertexConsumer, i, 1, 1, 1, 1, OverlayTexture.NO_OVERLAY, openMatrix4fs);
                    } else {
                        ClientModels.LOGICAL_CLIENT.bipedAlex.drawAnimatedModel(poseStack, vertexConsumer, i, 1, 1, 1, 1, OverlayTexture.NO_OVERLAY, openMatrix4fs);
                    }
                }
            }
        }
