...
public class EpicKKWeapons {
    ...
    public static final Function<Item, CapabilityItem.Builder> KEYBLADE = item ->
            WeaponCapability.builder()
                    ...
                    .newStyleCombo(KKStyles.SORA, KKAnimations.SORA_AUTO1, KKAnimations.SORA_AUTO2, Animations.DAGGER_AUTO3, Animations.AXE_AUTO1, Animations.DAGGER_DUAL_DASH, Animations.DAGGER_AIR_SLASH)
                    ...
                    .newStyleCombo(KKStyles.ROXAS, KKAnimations.ROXAS_AUTO1, Animations.DAGGER_AUTO2, Animations.DAGGER_AUTO3, Animations.AXE_AUTO1, Animations.DAGGER_DUAL_DASH, Animations.DAGGER_AIR_SLASH)
