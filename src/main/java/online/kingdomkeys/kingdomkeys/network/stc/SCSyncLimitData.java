...
public class SCSyncLimitData {
	...
	public SCSyncLimitData() {
	}

	public List<String> names = new LinkedList<String>();
	public List<String> data = new LinkedList<String>();

	public SCSyncLimitData(List<String> names, List<String> data) {
		this.names = names;
		this.data = data;
	}
	...
	public static SCSyncLimitData decode(FriendlyByteBuf buffer) {
		SCSyncLimitData msg = new SCSyncLimitData();
	...
	public static void handle(final SCSyncLimitData message, Supplier<NetworkEvent.Context> ctx) {
		ctx.get().enqueueWork(() -> DistExecutor.safeRunWhenOn(Dist.CLIENT, () -> ClientUtils.syncLimitData(message)));
