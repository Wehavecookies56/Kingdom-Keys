...
public abstract class EntityItemDrop extends Entity {
	public int xpColor;
	public int xpOrbAge;
	...
	public EntityItemDrop(EntityType<EntityItemDrop> type, FMLPlayMessages.SpawnEntity spawnEntity, World world) {
		super(type, world);
	}
	
	public EntityItemDrop(EntityType<? extends Entity> type, World world) {
		super(type, world);
	}
