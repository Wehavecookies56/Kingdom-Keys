...
public class ArrowgunShotEntity extends ThrowableProjectile {
	...
	public ArrowgunShotEntity(FMLPlayMessages.SpawnEntity spawnEntity, Level world) {
				...
				if (target != getOwner()) {
					...
					if(this.getOwner() instanceof Player) {
						...
						if(player.getMainHandItem() != null) {
							dmg = DamageCalculation.getOrgStrengthDamage(player, player.getMainHandItem()) / 2;
						}
					}
