...
public class AssassinEntity extends Monster implements IKHMob {

	public AssassinEntity(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
	}

	public AssassinEntity(FMLPlayMessages.SpawnEntity spawnEntity, Level world) {
