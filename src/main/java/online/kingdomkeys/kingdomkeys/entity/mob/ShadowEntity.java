...
public class ShadowEntity extends Monster implements IKHMob {

    public ShadowEntity(EntityType<? extends Monster> type, Level worldIn) {
        super(type, worldIn);
    }

    public ShadowEntity(FMLPlayMessages.SpawnEntity spawnEntity, Level world) {
