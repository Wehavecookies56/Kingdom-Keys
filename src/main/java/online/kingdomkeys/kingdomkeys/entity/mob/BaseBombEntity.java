...
public abstract class BaseBombEntity extends Monster implements IKHMob, IEntityAdditionalSpawnData {
    ...
    public BaseBombEntity(EntityType<? extends Monster> type, FMLPlayMessages.SpawnEntity spawnEntity, Level world) {
        super(type, world);
    }
