...
public class BloxBugEntity extends PathfinderMob implements GeoEntity, IKHMob, IEntityWithComplexSpawn {
    ...
    public void tick() {
        ...
        if (getTarget() == null) {
            if (getState() == CHARGE || getState() == JUMP_ATTACK) {
                setState(IDLE);
                stopTriggeredAnim("anims", "charge_loop");
            }
    ...
    public void writeSpawnData(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
        registryFriendlyByteBuf.writeBoolean(fromBlock);
    }

    @Override
    public void readSpawnData(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
        fromBlock = registryFriendlyByteBuf.readBoolean();
    }
        ...
        public boolean canContinueToUse() {
            ...
            switch (instance.getState()) {
                    ...
                    if (target != null) {
                        ...
                        if (attackTicks > nextAttack) {
                            ...
                            if (target.closerThan(instance, 2)) {
                                ...
                                instance.stopTriggeredAnim("anims", "charge_loop");
                            }
                        }
                    }
                }
                    ...
                    if (prepareTicks <= 0) {
                        ...
                        if (targetPosCache != null) {
                            ...
                            if (!instance.isFree(targetDirection.x, targetDirection.y, targetDirection.z) && targetPosCache.distanceTo(instance.position()) > chargeDistance*2) {
                                ...
                                instance.stopTriggeredAnim("anims", "charge_ready");
                            }
                            prepareTicks--;
                ...
                case COOLDOWN -> {
                    ...
                    if (cooldownTicks <= 0) {
                        instance.setState(IDLE);
                        instance.stopTriggeredAnim("anims", "jump_attack");
                        instance.stopTriggeredAnim("anims", "charge_stop");
                    }
                }
            }
