...
public class EntityBlizzard extends ThrowableEntity {

	int maxTicks = 100;

	public EntityBlizzard(EntityType<? extends ThrowableEntity> type, World world) {
		super(type, world);
		this.preventEntitySpawning = true;
	}

	public EntityBlizzard(FMLPlayMessages.SpawnEntity spawnEntity, World world) {
		super(ModEntities.TYPE_BLIZZARD, world);
	}
	...
	public EntityBlizzard(World world, PlayerEntity player) {
		super(ModEntities.TYPE_BLIZZARD, player, world);
	}
