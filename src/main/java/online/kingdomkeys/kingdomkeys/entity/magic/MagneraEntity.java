...
public class MagneraEntity extends BaseMagicProjectile {
	...
	public void tick() {
		...
		if (tickCount == maxTicks - 25) {
			getOwner().level().playSound(null, getOwner().blockPosition(), ModSounds.magnet2.get(), SoundSource.PLAYERS, 1F, 0.9F);
		}
