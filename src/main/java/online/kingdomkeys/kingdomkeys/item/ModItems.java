...
public class ModItems {
    ...
    public static final RegistryObject<Item>
			...
			dreamShield = createNewItem(Strings.dreamShield, () -> new SwordItem(new KeybladeItemTier(0), 2, 1, new Item.Properties().tab(KingdomKeys.keybladesGroup).stacksTo(1))),
    		...
    		recipe = createNewItem("recipe", () -> new RecipeItem(new Item.Properties().tab(KingdomKeys.miscGroup).stacksTo(1))),
	...
	public static RegistryObject<Item> createKeybladeItem(String name) {
		...
		RegistryObject<Item> thing = ITEMS.register(name, () -> new KeybladeItem(new Item.Properties().tab(KingdomKeys.keybladesGroup).stacksTo(1)));
	...
	private static RegistryObject<Item> createArmorItem(String name, KKArmorMaterial material, EquipmentSlot slot) {
