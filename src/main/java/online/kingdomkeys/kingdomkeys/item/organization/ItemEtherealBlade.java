...
import online.kingdomkeys.kingdomkeys.item.ItemTierKeyblade;
...
public class ItemEtherealBlade extends ItemSword implements IOrgWeapon {
    private OrganizationData data;

    //TODO remove attack damage
    public ItemEtherealBlade(String name, int attackDamageIn, float attackSpeedIn) {
