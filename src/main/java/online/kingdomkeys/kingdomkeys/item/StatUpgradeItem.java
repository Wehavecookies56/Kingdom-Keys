...
public class StatUpgradeItem extends Item implements IItemCategory {
	...
	public void appendHoverText(ItemStack stack, TooltipContext tooltipContext, List<Component> tooltip, TooltipFlag flagIn) {
		if(Minecraft.getInstance().player != null) {			
			switch (boost) {
			case Strings.powerBoost:
				tooltip.add(Component.translatable("gui.statboost.tooltip",Component.translatable((Strings.Gui_Menu_Status_Strength))));
				break;
			case Strings.magicBoost:
				tooltip.add(Component.translatable("gui.statboost.tooltip",Component.translatable((Strings.Gui_Menu_Status_Magic))));
				break;
			case Strings.defenseBoost:
				tooltip.add(Component.translatable("gui.statboost.tooltip",Component.translatable((Strings.Gui_Menu_Status_Defense))));
				break;
			case Strings.apBoost:
				tooltip.add(Component.translatable("gui.statboost.tooltip",Component.translatable((Strings.Gui_Menu_Status_AP))));
				break;
			}
