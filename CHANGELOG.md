**Added:**
* Grand magic extender ability which boosts grand magic Situation Commands duration by 25% after each equip.
  * Obtained at level 17 and 29 for warrior, 9 and 20 for mystic, 10 and 27 for guardian.
* Magic target block, outputting a redstone signal depending on the magic type that hit it:
  * It ranges from 1-8 as follows: fire, ice, water, lightning, aero, stop, darkness, light.
...
* Magnet Blox particles are now trails, reassembling the particles from the game.
